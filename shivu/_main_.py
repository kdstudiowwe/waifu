...
rarity_emojis = { "Common": "⚪", "Rare": "🔵", "Legendary": "🟡", "Exclusive": "🔴", "Mythical": "🟣", "Celestial": "✨" }

drop_rates = { "Common": 90, "Rare": 90, "Legendary": 50, "Exclusive": 10, "Mythical": 0.5, "Celestial": 0.0001  # Appears only once a month }
...
character = random.choices(available_characters, weights=[drop_rates[c['rarity']] for c in available_characters], k=1)[0]
...
await context.bot.send_photo(
    ...
    caption=f"""
    A New {emoji} {character['rarity']} Character Appeared...
    /guess Character Name and add to Your Harem
    """,
    parse_mode='Markdown'
    )
